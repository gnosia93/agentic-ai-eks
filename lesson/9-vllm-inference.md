...
```bash
curl -o vllm-deployment.yaml https://raw.githubusercontent.com/gnosia93/eks-agentic-ai/refs/heads/main/code/yaml/vllm-deployment.yaml
kubectl -f vllm-deployment.yaml
```
